...
//			statement.execute("DROP TABLE PORTFOLIOS");
		...
		statement.execute("CREATE TABLE PORTFOLIOS (USER_ID VARCHAR(50) NOT NULL, TICKER VARCHAR(10) NOT NULL, SHARES INT NOT NULL, PRIMARY KEY(TICKER))");
	...
	public static String tradeStock(String username, long cashId, String ticker, String orderType, int shares) {
		...
		try {
			...
			if(tradeSpent<0) {
				...
				statement.execute("INSERT INTO STOCKTRANSACTIONS (ACCOUNTID, DATE, TICKER, NAME, SHARES, ACITON,TYPE, PRICE) VALUES ("+cashId+",'"+date+"','"+ticker+"','"+stockName+"',"+shares+",'BUY','"+orderType+"',"+currentPrice+")" );

			}else {
				statement.execute("INSERT INTO TRANSACTIONS (ACCOUNTID, DATE, TYPE, AMOUNT) VALUES ("+cashId+",'"+date+"','Sell Stock',"+tradeSpent+")" );
				statement.execute("INSERT INTO STOCKTRANSACTIONS (ACCOUNTID, DATE, TICKER, NAME, SHARES, ACITON,TYPE, PRICE) VALUES ("+cashId+",'"+date+"','"+ticker+"','"+stockName+"',"+shares+",'SELL','"+orderType+"',"+currentPrice+")" );
			}
