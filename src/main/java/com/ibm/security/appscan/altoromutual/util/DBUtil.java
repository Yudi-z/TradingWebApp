...
**
	...
	private void initDB() throws SQLException{
		...
		statement.execute("CREATE TABLE PORTFOLIOS (ACCOUNT_ID BIGINT NOT NULL, TICKER VARCHAR(10) NOT NULL, SHARES INT NOT NULL, PRIMARY KEY(ACCOUNT_ID), FOREIGN KEY (TICKER) REFERENCES STOCKS(TICKER))");
